...
docker run -v ./router_service/configs:/build/configs -v /usr/local/ffmpeg:/usr/local/ffmpeg --name router_service_container --network host -d router_service_image
